...
class SalesInvoiceUI(ctk.CTkFrame):
    ...
    def _build_ui(self):
        ...
        labels = [
            ...
            ("CGST:", self.cgst_total_var),
            ("SGST:", self.sgst_total_var),
            ("IGST:", self.igst_total_var),
        ...
        for i, (text, var) in enumerate(labels):
            ...
            font = ctk.CTkFont(size=14, weight="bold") if text == "Grand Total:" else ctk.CTkFont(size=12)
            color = ACCENT if text == "Grand Total:" else None
